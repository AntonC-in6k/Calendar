...
public class ANSIICalendar {
    ...
    public ANSIICalendar(ArrayList<Integer> data, LocalDate date) {
        this.data = data;
    ...
    protected StringBuilder createOutputFormatMonthTitle(int month, int year) {
    ...
    protected StringBuilder createOutputFormatDaysTitle() {
        StringBuilder result = new StringBuilder();
    ...
    protected StringBuilder createOutputFormatCalendarData(ArrayList<Integer> data) {
        String emptySpace = "";
    ...
    public void getCalendar() {
        System.out.println(createOutputFormatMonthTitle(month, year));
        System.out.println(createOutputFormatDaysTitle());
        System.out.println(createOutputFormatCalendarData(data));
    }
}
